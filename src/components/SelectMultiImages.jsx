...
const SelectMultiImages = () => {
  const acceptedNumberOfImages = 5;
  ...
  return (
    <div className="py-10 px-5">
        <div className="p-10 flex flex-col sm:flex-row items-center bg-gray-700 dark:bg-darkbg1 rounded-xl">
          <div className="max-w-[50vw] flex justify-center items-center">
            <SliderComponent
              className={`max-w-[60vw] sm:max-w-[48vw] min-h-[200px] py-[25px] w-[${
                ...
                .map((_, idx) => (
                  <div className="relative flex justify-center items-center">
                    {selectedImages.length > idx ? (
                      ...
                      <div className="w-[150px] h-[150px] bg-red-900"></div>
                    )}
                    {selectedImages.length > idx && (
          ...
          <label className="group cursor-pointer flex items-center justify-center text-center border-two border border-dotted min-h-[200px] w-fit px-8 mx-auto rounded-xl hover:border-green-700 transition-all duration-500">
            <div className="flex flex-col gap-4">
              <PlusIcon className="w-[100px] h-[100px]" />
              <p className="text-xl text-two font-semibold">Add Image</p>
            </div>
            <input
              type="file"
              className="hidden"
